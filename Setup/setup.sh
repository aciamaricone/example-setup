...
export USER_NAME=$3
export USER_EMAIL1=$USER_NAME@acxiom.com
export USER_EMAIL2=$4@acxiom.com
export USER_EMAIL3=$5@acxiom.com
export USER_EMAIL4=$6@acxiom.com
export USER_EMAIL5=$7@acxiom.com
